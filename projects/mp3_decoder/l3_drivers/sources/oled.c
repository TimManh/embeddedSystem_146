...
/* ASCII-128 Slot */
static function_pointer_char char_callback[140];
...
void char_array_table() {
  ...
  char_callback[128] = char_smallest_square;
  char_callback[129] = char_small_square;
  char_callback[130] = char_medium_square;
  char_callback[131] = char_full_square;
}
